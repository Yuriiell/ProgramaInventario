...
{
    public partial class MermasComidaPersonal : Form
    {

        //en la base de datos la tabla se llama GastosComidaPersonal

        public MermasComidaPersonal()
        {
            InitializeComponent();
        }
        ...
        private void dataGridViewTablaMermasPlatosDevueltos_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {

        }

        //aqui se ingersa la cantidad de kilos por mes, es el campo KilosXMes de la tabla
        ...
        private void MermasComidaPersonal_Load(object sender, EventArgs e)
        {
