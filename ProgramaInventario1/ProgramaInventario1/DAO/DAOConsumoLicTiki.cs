...
{
    internal class DAOConsumoLicTiki
    {
        ...
        public void InsertarLicorConsumo(int idLicor, decimal pedidos, decimal medida, decimal invInicial, int botella, decimal trago, decimal ventas)
        {
            ...
            using (conexion)
            {
                string query = "INSERT INTO ConsumoLicTiki (idLicor, pedidos, medida, invInicial,botella,trago,ventas) " +
        ...
        public void EliminarLicorConsumo(int id)
        {
            ...
            using (conexion)
            {
                string query = "DELETE FROM ConsumoLicTiki WHERE idConsumoLicRest = @Id";
        ...
        public static void ActualizarLicorConsumo(int id, int idLicor, decimal pedidos, decimal medida, decimal invInicial, int botella, decimal trago, decimal ventas)
        {
            ...
            using (conexion)
            {
                string query = "UPDATE ConsumoLicTiki SET idLicor=@idLicor, pedidos=@pedidos, medida=@medida, invInicial=@invInicial,botella=@botella,trago=@trago,ventas=@ventas WHERE idConsumoLicRest = @Id";
        ...
        public List<LicorConsumo> ObtenerLicoresConsumo()
        {
            ...
            using (conexion)
            {
                string query = "SELECT idConsumoLicRest, idLicor, pedidos, medida, invInicial,botella,trago,ventas FROM ConsumoLicTiki";
        ...
        public LicorConsumo ObtenerLicorConsumoPorId(int id)
        {
            ...
            using (conexion)
            {
                string query = "SELECT idConsumoLicRest, idLicor, pedidos, medida, invInicial,botella,trago,ventas FROM ConsumoLicTiki WHERE idConsumoLicRest = @Id";
