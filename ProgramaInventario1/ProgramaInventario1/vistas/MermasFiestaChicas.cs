...
{
    public partial class MermasFiestaChicas : Form
    {

        //en la base de datos la tabla se llama FiestaChicas

        public MermasFiestaChicas()
        {
            InitializeComponent();
        }
        ...
        private void dataGridViewTablaMermasFiestaChicas_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {

        }

        //aqui se ingersa la cantidad de pproducto, es el campo Cantidad de la tabla
