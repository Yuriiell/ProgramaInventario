...
{
    public partial class MermasPlatosDevueltos : Form
    {

        //en la base de datos la tabla se llama PlatosDevueltos

        public MermasPlatosDevueltos()
        {
            InitializeComponent();
        }
        ...
        //aqui se ingersa la cantidad de platos devueltos, es el campo Cantidad de la tabla
