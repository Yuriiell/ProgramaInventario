...
{
    internal class DAOSobranteRestaurante
    {
        ...
        public void InsertarSobrante(decimal turnoAM, decimal turnoPM)
        {
            ...
            using (conexion)
            {
                string query = "INSERT INTO sobranteRestaurante (turnoAM, turnoPM) " +
        ...
        public void Eliminarsobrante(int id)
        {
            ...
            using (conexion)
            {
                string query = "DELETE FROM sobranteRestaurante WHERE idSobranteRest = @Id";
        ...
        public static void ActualizarSobrante(int id, decimal turnoAM, decimal turnoPM)
        {
            ...
            using (conexion)
            {
                string query = "UPDATE sobranteRestaurante SET turnoAM=@turnoAM, turnoPM=@turnoPM WHERE idSobranteRest = @Id";
        ...
        public List<Sobrante> ObtenerSobrante()
        {
            ...
            using (conexion)
            {
                string query = "SELECT idSobranteRest, turnoAM, turnoPM FROM sobranteRestaurante";
        ...
        public Sobrante ObtenerSobrantePorId(int id)
        {
            ...
            using (conexion)
            {
                string query = "SELECT idSobranteRest, turnoAM, turnoPM FROM sobranteRestaurante WHERE idSobranteRest = @Id";
